...
namespace Drupal\reseau_mod_up_webform_dir_sxmsbh\Controller;
...
/**
 * Class WebformSubmissionChangerStatutDir_sxmsbhController.
 *
 * @package Drupal\reseau_mod_up_webform_dir_sxmsbh\Controller
 */
class WebformSubmissionChangerStatutDir_sxmsbhController extends ControllerBase
{
  ...
  {
    return AccessResult::allowedIf(!$submission->isDraft() && array_intersect(array('administrator', 'webmaster_greta_sxmsbh', 'webmaster_reseau'), $this->currentUser()->getRoles()) !== []);
  }
}
