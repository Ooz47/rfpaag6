...
namespace Drupal\reseau_mod_up_webform_dir_cfapag\Controller;
...
/**
 * Class WebformSubmissionChangerStatutDir_cfapagController.
 *
 * @package Drupal\reseau_mod_up_webform_dir_cfapag\Controller
 */
class WebformSubmissionChangerStatutDir_cfapagController extends ControllerBase
{
  ...
  {
    return AccessResult::allowedIf(!$submission->isDraft() && array_intersect(array('administrator', 'webmaster_cfapag', 'webmaster_reseau'), $this->currentUser()->getRoles()) !== []);
  }
}
