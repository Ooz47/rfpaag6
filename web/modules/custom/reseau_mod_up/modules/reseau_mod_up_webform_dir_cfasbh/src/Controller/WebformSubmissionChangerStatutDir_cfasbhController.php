...
namespace Drupal\reseau_mod_up_webform_dir_cfasbh\Controller;
...
/**
 * Class WebformSubmissionChangerStatutDir_cfasbhController.
 *
 * @package Drupal\reseau_mod_up_webform_dir_cfasbh\Controller
 */
class WebformSubmissionChangerStatutDir_cfasbhController extends ControllerBase
{
  ...
  {
    return AccessResult::allowedIf(!$submission->isDraft() && array_intersect(array('administrator', 'webmaster_cfasbh', 'webmaster_reseau'), $this->currentUser()->getRoles()) !== []);
  }
}
