        ...
        if ($this->runInSeparateProcess()) {
            ...
            if ($runEntireClass) {
                $template = new Template(
                    'C:\laragon\www\greta-cfa-gipdaifi\vendor\composer/../phpunit/phpunit/src/Util/PHP/Template/TestCaseClass.tpl',
                );
            } else {
                $template = new Template(
                    'C:\laragon\www\greta-cfa-gipdaifi\vendor\composer/../phpunit/phpunit/src/Util/PHP/Template/TestCaseMethod.tpl',
                );
            }
